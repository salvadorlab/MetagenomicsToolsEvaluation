...
metaphlan2.py $path/R22.K/R22.K_1_kneaddata_paired_1.fastq $path/R22.K/R22.K_1_kneaddata_paired_2.fastq --bowtie2out R22.K.bowtie2out.bz2 --input_type fastq --bowtie2db METAPHLAN_BOWTIE2_DB > /scratch/rx32940/Metagenomic_taxon_profile/R22.K_metaPhlAn2.txt
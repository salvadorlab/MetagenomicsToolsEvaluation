...
ggplot(clarks_deseq_lineage, aes(x=Genus, y=log2FoldChange, color= Phylum))+ geom_point(size=6) + 
  theme_classic()+
  theme(legend.key.size = unit(1.0, "cm"), legend.text = element_text(size=13),legend.title = element_text(size=14), strip.text = element_text(face="bold",size=12), axis.text.x = element_text(face="bold",size=12,angle = -90, hjust = 0, vjust=0.5), axis.title.y=element_text(size=12, face="bold")) 

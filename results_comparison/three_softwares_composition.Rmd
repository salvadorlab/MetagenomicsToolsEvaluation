...
per_sofr_domain <- ggplot(combined_domain_software_2 %>% subset(Read_type == "Percentage"), aes(x= samples, y = values))+
  ...
  scale_fill_manual(values = manual_color)+
  theme_classic()+
  theme(axis.text.x = element_text(angle = 90,size=12), axis.text.y = element_text(size = 10), strip.placement = "none", axis.title = element_blank(), axis.title.y = element_blank(), strip.text = element_text(size = 12), legend.title = element_text(size=12), legend.text = element_text(size=12), legend.position = "none")+
...
ggsave("/Users/rachel/Desktop/combined_software_domain.pdf", combined_software_domain, height = 6)
```
...
clark_phylum_1 <- clark_phylum %>% rename( Name = "Phylum", Samples = "samples", Read_Count = "Reads")
clarks_phylum_1 <- clarks_phylum %>%  rename( Name = "Phylum", Samples = "samples", Read_Count = "Reads")
...
library(gridExtra)
library(scales)
abs_phylum_p <- ggplot(combined_soft_phylum_longer_1 %>% subset(Read_type == "Reads"), aes(x= samples, y=values), ncol=2)+
...
per_phylum_p <- ggplot(combined_soft_phylum_longer_1 %>% subset(Read_type == "Proportion"), aes(x= samples, y=values), ncol=2)+
  geom_bar(stat="identity", aes(fill=Phylum))+
...
ggsave("/Users/rachel/Desktop/combined_phylum_software.pdf", combined_phylum_software,height = 7)
```

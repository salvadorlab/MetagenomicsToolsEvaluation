...
wilcox.test(mini_cus_other$other_seq_reads ~ mini_cus_other$db, paired=TRUE,alternative="greater") # not rejected
...
wilcox.test(std_cus_other$other_seq_reads ~ std_cus_other$db,paired=TRUE,alternative="greater") # rejected
std_cus_other
```

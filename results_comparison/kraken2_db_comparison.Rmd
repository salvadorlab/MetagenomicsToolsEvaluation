...
plot_kraken2_p <- ggplot(combined_kraken2_db_longer,aes(x= `Kraken2 Database Comparison`, y= `Reads`))+
      geom_boxplot()+
  scale_shape_manual(values=c(seq(1,10,2),seq(10,16,1)))+
...
plot_kraken2_p 
ggsave(plot = plot_kraken2_p, width = 10, height = 8, dpi = 500, filename = "/Users/rx32940/Desktop/kraken2_db_boxplot.pdf")
```

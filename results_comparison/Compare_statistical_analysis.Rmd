...
genus_Kraken2_1 <- genus_Kraken2 %>% rename(Genus = OTU)
...
software_alpha_p <- ggplot(combined_alpha_software_longer, aes(x= software, y=`Index Value`))+
 ...
 software_alpha_p
# ggsave(plot = software_alpha_p, width = 10, height = 5, dpi = 500, filename = "/Users/rachel/Desktop/software_alpha_boxplot.pdf")
...
library(gplots)
# pdf('/Users/rachel/Desktop/kraken2_beta_heatmap.pdf')
...
pdf('/Users/rachel/Desktop/clark_beta_heatmap.pdf')
heatmap.2(as.matrix(beta_dist_clark),key=TRUE, symkey=FALSE, density.info="none", trace="none",cexRow = 1.6,cexCol = 1.6,margins = c(6,6))
dev.off


# pdf('/Users/rachel/Desktop/clark-s_beta_heatmap.pdf')

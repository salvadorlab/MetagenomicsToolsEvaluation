...
plot_domain <- ggplot(domain_full_table, aes(x=Samples, y=Read_Count, fill=Name)) +
  ...
  labs(title = "Metagenomic Reads Classification with Clark-S (with Rat) DB (Domain)", y= "Number of Reads",
       x="Samples")
...
plot_phylum <- ggplot(phylum_full_table, aes(x=Samples, y=Read_Count, fill=Name)) +
  geom_bar(stat="identity") + 
  theme(axis.text.x=element_text(angle=90)) +
  labs(title = "Metagenomic Reads Classification with Clark-S (with Rat) DB (Phylum)", y= "Number of Reads",
       x="Samples")
...
plot_genus <- ggplot(genus_full_table, aes(x=Samples, y=Read_Count, fill=Name)) +
  geom_bar(stat="identity") + 
  theme(axis.text.x=element_text(angle=90)) +
  labs(title = "Metagenomic Reads Classification with Clark-S (with Rat) DB (Genus)", y= "Number of Reads",
       x="Samples") +

...
plot_domain <- ggplot(domain_full_table, aes(x=Samples, y=Read_Count, fill=Name)) +
  ...
  labs(title = "Metagenomic Reads Classification with Clark-S DB (Domain)", y= "Number of Reads",
       x="Samples") +
...
domain_relative <- ggplot(domain_major, aes(x=Samples, y=Relative, fill=Name)) +
  geom_bar(stat="identity") + 
  theme(axis.text.x=element_text(angle=90)) +
  labs(title = "Metagenomic Relative Abundance Classification with Clark-S DB (Domain)",
...
order_phylum <- c("Proteobacteria","Actinobacteria","Cyanobacteria","Firmicutes","Bacteroidetes","Tenericutes","Spirochaetes","Aquificae","Peploviricota","Deinococcus-Thermus","Planctomycetes") 
...
manual_color <-c("#F94144","#80B918","#FEE440","#4361EE","#FFADAD","#FDFFB6","#CAFFBF","#BDB2FF","#FCCA46","#A1C181",
                 "#619B8A","#EE6352","#59CD90","#3FA7D6","#FAC05E","#F79D84","#50514F","#F25F5C","#FFE066","#247BA0","#70C1B3",
                 "#FFD1E8","#C8A439","#465D6F","#A94303","#708841","#540D6E","#EE4266","#FFD23F","#3BCEAC","#0EAD69","#E3AB00ff","#D1DED3ff",
                 "#AD8EB0ff","#58BADCff","#A71D2Eff","#86D8BBff","#0050ADff","#97CBF0ff","#67A280ff","#F20089","#41EAD4","#FBFF12","#54478C")
...
plot_phylum <- ggplot(phylum_full_table, aes(x=Samples, y=Read_Count, fill=Name)) +
  ...
  labs(title = "Clark-S Microbiome Reads Profile (Phylum)", y= "Number of Reads",
       x="Samples") +
  scale_fill_manual(values = manual_color)
...
phylum_relative <- ggplot(phylum_major, aes(x=Samples,y=Percentage, fill=Name)) + 
  ...
  labs(title = "Clark-S Microbiome Composition Profile (Phylum)", y= "Percentage", x="Samples" )+scale_y_continuous(labels = scales::percent_format()) +
  scale_fill_manual(values = manual_color)

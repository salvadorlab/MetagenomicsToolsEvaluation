...
order_phylum <- c("Proteobacteria","Actinobacteria","Cyanobacteria","Firmicutes","Bacteroidetes","Uroviricota","Tenericutes","Spirochaetes","Aquificae","Artverviricota","Peploviricota","Deinococcus-Thermus","Planctomycetes") 
...
phylum_full_table %>% group_by(Samples) %>% 
  ...
  subset(Percentage >= 0.01)-> phylum_major
...
manual_color <-c("#4361EE","#9BF6FF","#FFADAD","#FDFFB6","#FFD6A5","#A0C4FF","#BDB2FF","#465D6F","#A94303","#EE6352","#59CD90","#3FA7D6","#A94303","#F79D84","#FAC05E","#50514F","#80B918","#FEE440","#4361EE","#FFADAD","#FFD6A5","#FDFFB6","#CAFFBF","#BDB2FF","#FCCA46","#A1C181","#619B8A","#EE6352","#59CD90","#3FA7D6","#FAC05E","#F79D84","#50514F","#F25F5C","#FFE066","#247BA0","#70C1B3",
                 "#FFD1E8","#C8A439","#465D6F","#A94303","#708841","#540D6E","#EE4266","#FFD23F","#3BCEAC","#0EAD69","#E3AB00ff","#D1DED3ff",

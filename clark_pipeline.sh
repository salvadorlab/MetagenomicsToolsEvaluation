#!/bin/bash
#PBS -q highmem_q                                                            
#PBS -N clark-classify                                       
#PBS -l nodes=1:ppn=12 -l mem=200gb                                        
...
#$path/CLARKSCV1.2.6.1/classify_metagenome.sh -n 1 -P $seq_path/${sample}_1_kneaddata_paired_1.fastq.paired.fq $seq_path/${sample}_1_kneaddata_paired_2.fastq.paired.fq -R $path/output_species/R22.K
...
do
   #  sample=$(basename "$file" "_1_kneaddata_unmatched_1.fastq")
    $path/CLARKSCV1.2.6.1/classify_metagenome.sh -n 12 -P $seq_path/${sample}_1_kneaddata_paired_1.fastq.paired.fq $seq_path/${sample}_1_kneaddata_paired_2.fastq.paired.fq -R $path/output_species/$sample
done

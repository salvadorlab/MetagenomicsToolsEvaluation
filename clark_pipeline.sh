...
#$path/CLARKSCV1.2.6.1/classify_metagenome.sh -n 1 -P $seq_path/${sample}_1_kneaddata_paired_1.fastq.paired.fq $seq_path/${sample}_1_kneaddata_paired_2.fastq.paired.fq -R $path/output_species_rat/R22.K

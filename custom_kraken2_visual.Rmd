...
manual_color <-c("#4361EE","#9BF6FF","#FFADAD","#FDFFB6","#FFD6A5","#CAFFBF","#A0C4FF","#BDB2FF","#FFC6FF","#233D4D","#FE7F2D","#FCCA46","#A1C181",
                 "#619B8A","#EE6352","#59CD90","#3FA7D6","#FAC05E","#A94303","#50514F","#F25F5C","#FFE066","#247BA0","#70C1B3",
...
phylum_all_samples %>% group_by(samples) %>%
  mutate(Total=sum(Reads), Percentage = Reads/Total) %>% subset(Percentage >= 0.01) ->major_phylum
major_phylum

...
$path/CLARK/CLARKSCV1.2.6.1/classify_metagenome.sh -P $path/CLARK/CLARKSCV1.2.6.1/samples.R.txt $path/CLARK/CLARKSCV1.2.6.1/samples.R.txt -R $path/CLARK/CLARKSCV1.2.6.1/results_G_regular.txt
...
for file in /scratch/rx32940/CLARK/output/custom/genus/regular/*; do 
  ...
  $path/CLARK/CLARKSCV1.2.6.1/estimate_abundance.sh -F /scratch/rx32940/CLARK/output/custom/genus/regular/$sample_csv.txt.csv -D $path/CLARK/DB > /scratch/rx32940/CLARK/output/abundance/genus/${sample_csv}_abundance.txt
done
...
$path/CLARK/CLARKSCV1.2.6.1/classify_metagenome.sh -n 12 -P $path/CLARK/CLARKSCV1.2.6.1/samples.R.txt $path/CLARK/CLARKSCV1.2.6.1/samples.R.txt -R $path/CLARK/CLARKSCV1.2.6.1/results_G_spaced.txt --spaced

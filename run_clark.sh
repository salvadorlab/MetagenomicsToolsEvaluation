...
$path/CLARK/CLARKSCV1.2.6.1/classify_metagenome.sh -P $path/Metagenomic_taxon_profile/Data/01.Data/hostclean/R27.K/R27.K_1_kneaddata_paired_1.fastq $path/Metagenomic_taxon_profile/Data/01.Data/hostclean/R27.K/R27.K_1_kneaddata_paired_2.fastq -R /scratch/rx32940/CLARK/output/custom/species/regular/R27.K.txt
...
$path/CLARK/CLARKSCV1.2.6.1/classify_metagenome.sh -n 8 -P $path/Metagenomic_taxon_profile/Data/01.Data/hostclean/R27.K/R27.K_1_kneaddata_paired_1.fastq $path/Metagenomic_taxon_profile/Data/01.Data/hostclean/R27.K/R27.K_1_kneaddata_paired_2.fastq -R /scratch/rx32940/CLARK/output/custom/species/spaced/R27.K_spaced --spaced

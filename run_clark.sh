...
$path/CLARK/CLARKSCV1.2.6.1/classify_metagenome.sh -n 12 -P $path/CLARK/CLARKSCV1.2.6.1/samples.R.txt $path/CLARK/CLARKSCV1.2.6.1/samples.L.txt -R $path/CLARK/CLARKSCV1.2.6.1/results_P_regular.txt

echo "classify_metagenome done"

#analyze result from regular clark
for file in /scratch/rx32940/CLARK/output/custom/phylum/regular/*; do 
   sample_csv=$(basename "$file" ".csv")
  $path/CLARK/CLARKSCV1.2.6.1/estimate_abundance.sh -F /scratch/rx32940/CLARK/output/custom/phylum/regular/$sample_csv.csv -D $path/CLARK/DB > /scratch/rx32940/CLARK/output/abundance/phylum/${sample_csv}_abundance.txt
done
...
$path/CLARK/CLARKSCV1.2.6.1/classify_metagenome.sh -n 12 -P $path/CLARK/CLARKSCV1.2.6.1/samples.R.txt $path/CLARK/CLARKSCV1.2.6.1/samples.L.txt -R $path/CLARK/CLARKSCV1.2.6.1/results_P_spaced.txt --spaced

echo "spaced classification done"

#analyze result from spaced clark
for file in /scratch/rx32940/CLARK/output/custom/phylum/spaced/*; do 
   sample_csv=$(basename "$file" "_spaced.csv")
  $path/CLARK/CLARKSCV1.2.6.1/estimate_abundance.sh -F /scratch/rx32940/CLARK/output/custom/phylum/spaced/${sample_csv}_spaced.csv -D $path/CLARK/DB > /scratch/rx32940/CLARK/output/spaced_abundance/phylum/${sample_csv}_spaced_abundance.txt
done

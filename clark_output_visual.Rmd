...
phylum_plot <- ggplot(phylum_full_table, aes(x=Samples,y=Read_Count, fill=Name)) + 
  ...
  theme(axis.text.x = element_text(angle=90),legend.text = element_text(size = 8),legend.key.size = unit(0.5,"cm"))+
...
genus_plot <- ggplot(genus_full_table, aes(x=Samples,y=Read_Count, fill=Name)) + 
  geom_bar(stat="identity") +
  theme(axis.text.x = element_text(angle=90),legend.key.size = unit(0.5,"cm"), legend.text = element_text(size = 8)) +
